...
import com.tugas_day12.model.dto.UserDetDTO;
import com.tugas_day12.model.jwt.JwtRequest;
import com.tugas_day12.model.jwt.JwtResponse;
import com.tugas_day12.repository.UserRepo;
import com.tugas_day12.service.JwtUserDetailsService;
import com.tugas_day12.model.dto.UserDTO;
import com.tugas_day12.config.JwtTokenUtil;
import com.tugas_day12.service.TokenBlacklistService;
import com.tugas_day12.util.CustomErrorType;
import com.tugas_day12.config.JwtBlacklistFilter;
		...
		if (regexEmail && regexPassword) {
			if (!isExist) {
				...
				for (Map<String, Object> userDetObj : userDet) {
					...
					userDetDTO.setBalance(Double.parseDouble(userDetObj.get("balance").toString()));
